---
title: 'CSM Modsets 列表'
description: '自动同步 NEVSTOP-LAB/.github 仓库中的 csm-modsets 清单，汇总所有公开 csm-modsets 主题仓库并每日更新。'
draft: false
weight: 45
---

> 本页面由工作流每日自动同步，源文件：[`NEVSTOP-LAB/.github/csm-modsets.md`](https://github.com/NEVSTOP-LAB/.github/blob/main/csm-modsets.md)。
> 如需修正列表内容，请优先修改上游源文件。

# CSM Modsets Repositories

> 自动生成，最后更新时间：2026-06-10 03:16 UTC

所有公开的、主题（topic）为 [`csm-modsets`](https://github.com/search?q=topic%3Acsm-modsets&type=repositories) 的仓库列表。

## <a id="NEVSTOP-LAB"></a>[NEVSTOP-LAB](https://github.com/NEVSTOP-LAB) (9)

| 仓库 | ⭐ | 描述 |
|------|:---:|------|
| [CSMScript-Lite](https://github.com/NEVSTOP-LAB/CSMScript-Lite) | 22 | CSMScript Lite版本，一款轻量级脚本执行引擎，用于执行灵活的 CSM 测试脚本 |
...
| [CSM-Modsets-WaveformDisplay](https://github.com/NEVSTOP-LAB/CSM-Modsets-WaveformDisplay) | 4 | CSM 模块: 显示 Waveform |
...
| 仓库 | ⭐ | 描述 |
|------|:---:|------|
| [CSM-Modsets-SimWaveform](https://github.com/nevstop/CSM-Modsets-SimWaveform) | 4 | CSM Module: 模拟波形 |
| [CSM-Utils](https://github.com/nevstop/CSM-Utils) | 3 | 复用VI，还未被纳入到CSM的安装包中 |
