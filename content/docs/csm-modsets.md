...
> 自动生成，最后更新时间：2026-05-29 03:17 UTC
...
| 仓库 | ⭐ | 描述 |
|------|:---:|------|
| [CSMScript-Lite](https://github.com/NEVSTOP-LAB/CSMScript-Lite) | 20 | CSMScript Lite版本，一款轻量级脚本执行引擎，用于执行灵活的 CSM 测试脚本 |
...
| [CSM-Utils](https://github.com/nevstop/CSM-Utils) |  | 复用VI，还未被纳入到CSM的安装包中 |
