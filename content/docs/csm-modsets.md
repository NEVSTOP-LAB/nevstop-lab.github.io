...
> 自动生成，最后更新时间：2026-07-03 17:10 UTC
...
| 仓库 | ⭐ | 描述 |
|------|:---:|------|
| [CSMScript-Lite](https://github.com/NEVSTOP-LAB/CSMScript-Lite) | 26 | CSMScript Lite版本，一款轻量级脚本执行引擎，用于执行灵活的 CSM 测试脚本 |
...
| 仓库 | ⭐ | 描述 |
|------|:---:|------|
| [CSM-MDI-ViewManager](https://github.com/datadataup/CSM-MDI-ViewManager) | 3 | 基于LabVIEW CSM框架下的MDI模块，运行时对页面进行自定义布局管理 |
